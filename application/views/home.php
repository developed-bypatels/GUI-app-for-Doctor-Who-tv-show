                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-6 col-md-6">
                        <div class="illastrator_png">
                            <img src="<?= assetUrl(); ?>img/banner/edu_ilastration.png" alt="">
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-6">
                            ...
                            <ul class="nav" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                                        aria-controls="home" aria-selected="true">All Courses / Workshops</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                                        aria-controls="profile" aria-selected="false">Online Courses</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                                        aria-controls="contact" aria-selected="false">Workshops</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
            ...
            <div class="container">
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="row">
                                <? foreach ($courses_table as $row) { ?>
                                    <div class="col-xl-4 col-lg-4 col-md-6">
                                        <div class="single_courses">
                                            <div class="thumb">
                                                <a href="<?= base_url() ?>index.php?/Course_details">
                                                    <img src="<?= assetUrl(); ?><?= $row['image'] ?>" alt="">
                                                </a>
                                            </div>
                                            <div class="courses_info">
                                                <span><?= $row['category'] ?></span>
                                                <h3><a href="<?= base_url() ?>index.php?/Course_details"><?= $row['title'] ?></a></h3>
                                                <div class="star_prise d-flex justify-content-between">
                                                    ...
                                                    <div class="prise">
                                                        <span class="offer">$<?= $row['before_price'] ?></span>
                                ...
                                <? foreach ($workshops_table as $row) { ?>
                                    <div class="col-xl-4 col-lg-4 col-md-6">
                                        <div class="single_courses">
                                            <div class="thumb">
                                                <a href="<?= base_url() ?>index.php?/Course_details">
